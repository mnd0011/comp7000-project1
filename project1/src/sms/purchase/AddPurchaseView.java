    ...
    public void run()
    {
        ...
        try
        {
            if(StoreManager.getInstance() != null)
            {
                ...
                {
                    productList = StoreManager.getInstance().getDataAccess().loadAllProducts();
                    ...
                    customerList = StoreManager.getInstance().getDataAccess().loadAllCustomers();
